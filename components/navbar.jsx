            ...
            <div className="hidden md:block ml-10 flex items-baseline space-x-4">
              {navItems.map((item) => (
                <Link
                  ...
                  {item.name}
                  <span
                    className="absolute inset-x-0 bottom-0 h-0.5 bg-blue-500 transform origin-left scale-x-0 transition-transform duration-200 ease-in-out group-hover:scale-x-100"></span>
                </Link>
              ))}
            </div>
          </div>
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent side="right" className="w-[300px] bg-gray-900 text-white">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <Button
                    variant="ghost"
                    className="px-2 text-white hover:bg-gray-800"
